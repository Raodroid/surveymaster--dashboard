...
import DisplayAnswer from '@/modules/dashboard/pages/Project/ProjectContent/components/DetailSurvey/SurveyForm/SurveyFlow/SurveyPlayGround/elements/DisplayAnswer/DisplayAnswer';
...
const UploadExternalFile: FC<{
  ...
  return (
    <>
      ...
      {!displayParameterTable && !isExternalProject && (
        <GroupSurveyButton questionBlockIndex={questionBlockDefault} />
      )}

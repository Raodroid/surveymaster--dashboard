...
import EmbeddedBlockChoice from '@/modules/dashboard/pages/Project/ProjectContent/components/DetailSurvey/Components/SurveyFlow/SurveyPlayGround/elements/QuestionBlockCollapse/types/Branch/EmbeddedBlockChoice/EmbeddedBlockChoice';
import QuestionChoice from '@/modules/dashboard/pages/Project/ProjectContent/components/DetailSurvey/Components/SurveyFlow/SurveyPlayGround/elements/QuestionBlockCollapse/types/Branch/QuestionChoice/QuestionChoice';
